...
/*
check_user_exist - check if username already exist or not
adduser - add a user to the database
updateconfirmation - change flag of verified in database
login - check login credentials
logout - logout out user
getuserdetails - gets the details of logged in user
*/
