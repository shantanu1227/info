<!--
    ...
    <head>
        ...
        <link rel='stylesheet' type="text/css" href="<?php echo(CSS . 'termsnconditionsstyle.css'); ?>">
...
<body>
    <div id="box">
        ...
        <div class="shopheading">
            ...
            These Terms and various other policies are binding as per the provisions of the Information Technology (Intermediaries guidelines) Rules, 2011 formulated under the Information Technology Act of 2000.
            </p>
            <p>

            In these Terms, references to "you", "User" shall mean the end user accessing the Website, its contents and using the Services offered through the Website, "Service Providers" mean independent third party service providers.
            <p>
            1. Introduction:
</br>
a) www.virtualinfocity.com ("Website") is an Internet based content and e-commerce portal licensed by Vector E-commerce Private Limited, a company incorporated under the laws of India.
</br>
b) Use of the Website is offered to you conditioned on acceptance without modification of all the terms, conditions and notices contained in these Terms, as may be posted on the Website from time to time. virtualinfocity.com at its sole discretion reserves the right not to accept a User from registering on the Website without assigning any reason thereof.
</p>
<p>
...
The User agrees and undertakes not to reverse engineer, modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information or software obtained from the Website. Limited reproduction and copying of the content of the Website is permitted provided that virtualinfocity's name is stated as the source and prior written permission of virtualinfocity.com is sought. For the removal of doubt, it is clarified that unlimited or wholesale reproduction, copying of the content for commercial or non-commercial purposes and unwarranted modification of data and information within the content of the Website is not permitted.
</p>
<p>
...
Prices for products are described on our Website and are incorporated into these Terms by reference. All prices are in Indian rupees. Prices, products and Services may change at virtualinfocity's discretion.
</p><p>
6. Shipping:

Title and risk of loss for all products ordered by you shall pass on to you upon virtualinfocity's shipment to the shipping carrier.
</p><p>
7. Termination:
</br>
a)   virtualinfocity.com may suspend or terminate your use of the Website or any Service if it believes, in its sole and absolute discretion that you have breached, violated, abused, or unethically manipulated or exploited any term of these Terms or anyway otherwise acted unethically.
</br>
b)  Notwithstanding Section 7.a above, these Terms will survive indefinitely unless and until virtualinfocity.com chooses to terminate them.
</br>
c)   If you or virtualinfocity.com terminates your use of the Website or any Service, virtualinfocity.com may delete any content or other materials relating to your use of the Service and virtualinfocity.com will have no liability to you or any third party for doing so.
</br>
